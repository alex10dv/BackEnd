...
import com.myporfolio.ADV.Dto.dtoEducacion;
import com.myporfolio.ADV.Entity.Educacion;
import com.myporfolio.ADV.Security.Controller.Mensaje;
import com.myporfolio.ADV.Service.Seducacion;
...
public class CEducacion {
 ...
 public ResponseEntity<?> delete(@PathVariable("id") int id){
  ...
  return new ResponseEntity(new Mensaje("Eliminada la Educacion"),HttpStatus.OK);
 }
...
if (StringUtils.isBlank(dtoeducacion.getNombreE())){
 return new ResponseEntity(new Mensaje("El campo debe esta completado"), HttpStatus.BAD_REQUEST);
