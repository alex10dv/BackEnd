...
import com.myporfolio.ADV.Dto.dtoExperiencia;
import com.myporfolio.ADV.Entity.Experiencia;
import com.myporfolio.ADV.Security.Controller.Mensaje;
import com.myporfolio.ADV.Service.SExperiencia;
...
public class CExperiencia {
    ...
    @GetMapping("/lista")
    public ResponseEntity<List<Experiencia>> list(){ // lista que trae todas las experiencias
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        //Aca se compara nombre de la experiencias
